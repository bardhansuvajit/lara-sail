...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $file_validation = json_encode([
            'max_file_size' => '10000',
            'max_file_size_in_kb' => '10000 KB',
            'max_file_size_in_mb' => '10 MB',
            'file_upload_mimes_array' => ['pdf', 'doc', 'docx'],
        ]);
