    ...
    public function up(): void
    {
        ...
        $data = [
            ...
            [
                ...
                'icon' => '⚠️',
                'tailwind_classes' => 'bg-red-100 text-red-800 border border-red-200 dark:bg-red-900 dark:text-red-200 dark:border-red-800',
            ...
            [
                ...
                'icon' => '🔥',
                'tailwind_classes' => 'bg-amber-100 text-amber-800 border border-amber-200 dark:bg-amber-900 dark:text-amber-200 dark:border-amber-800',
                'meta' => null,
                'position' => 2,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '⏳',
                'tailwind_classes' => 'bg-orange-100 text-orange-800 border border-orange-200 dark:bg-orange-900 dark:text-orange-200 dark:border-orange-800',
            ...
            [
                ...
                'icon' => '🚨',
                'tailwind_classes' => 'bg-red-50 text-red-700 border border-red-100 dark:bg-red-800 dark:text-red-100 dark:border-red-700',
                'meta' => null,
                'position' => 4,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '🏆',
                'tailwind_classes' => 'bg-emerald-100 text-emerald-800 border border-emerald-200 dark:bg-emerald-900 dark:text-emerald-200 dark:border-emerald-800',
            ...
            [
                ...
                'icon' => '⭐',
                'tailwind_classes' => 'bg-sky-100 text-sky-800 border border-sky-200 dark:bg-sky-900 dark:text-sky-200 dark:border-sky-800',
            ...
            [
                ...
                'icon' => '💖',
                'tailwind_classes' => 'bg-pink-100 text-pink-800 border border-pink-200 dark:bg-pink-900 dark:text-pink-200 dark:border-pink-800',
                'meta' => null,
                'position' => 3,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '❤️',
                'tailwind_classes' => 'bg-rose-50 text-rose-700 border border-rose-100 dark:bg-rose-900 dark:text-rose-200 dark:border-rose-800',
                'meta' => null,
                'position' => 4,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '🎉',
                'tailwind_classes' => 'bg-violet-100 text-violet-800 border border-violet-200 dark:bg-violet-900 dark:text-violet-200 dark:border-violet-800',
                'meta' => null,
                'position' => 1,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '📌',
                'tailwind_classes' => 'bg-yellow-100 text-yellow-800 border border-yellow-200 dark:bg-yellow-900 dark:text-yellow-200 dark:border-yellow-800',
                'meta' => null,
                'position' => 3,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '🎁',
                'tailwind_classes' => 'bg-indigo-100 text-indigo-800 border border-indigo-200 dark:bg-indigo-900 dark:text-indigo-200 dark:border-indigo-800',
            ...
            [
                ...
                'icon' => '🔒',
                'tailwind_classes' => 'bg-amber-50 text-amber-800 border border-amber-100 dark:bg-amber-900 dark:text-amber-200 dark:border-amber-800',
                'meta' => null,
                'position' => 2,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '🚀',
                'tailwind_classes' => 'bg-emerald-50 text-emerald-800 border border-emerald-100 dark:bg-emerald-900 dark:text-emerald-200 dark:border-emerald-800',
                'meta' => null,
                'position' => 3,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '💎',
                'tailwind_classes' => 'bg-slate-100 text-slate-800 border border-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:border-slate-700',
                'meta' => null,
                'position' => 5,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '🔖',
                'tailwind_classes' => 'bg-slate-100 text-slate-800 border border-slate-200 dark:bg-slate-900 dark:text-slate-200 dark:border-slate-800',
                'meta' => null,
                'position' => 1,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '📦',
                'tailwind_classes' => 'bg-green-100 text-green-800 border border-green-200 dark:bg-green-900 dark:text-green-200 dark:border-green-800',
            ...
            [
                ...
                'icon' => '💰',
                'tailwind_classes' => 'bg-lime-100 text-lime-800 border border-lime-200 dark:bg-lime-900 dark:text-lime-200 dark:border-lime-800',
            ...
            [
                ...
                'icon' => '🏷️',
                'tailwind_classes' => 'bg-sky-50 text-sky-800 border border-sky-100 dark:bg-sky-900 dark:text-sky-200 dark:border-sky-800',
                'meta' => null,
                'position' => 5,
                'status' => 1,
                'created_at' => $now,
            ...
            [
                ...
                'icon' => '🚚',
                'tailwind_classes' => 'bg-cyan-100 text-cyan-800 border border-cyan-200 dark:bg-cyan-900 dark:text-cyan-200 dark:border-cyan-800',
            ...
            [
                ...
                'icon' => '🔒',
                'tailwind_classes' => 'bg-slate-50 text-slate-800 border border-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:border-slate-700',
            ...
            [
                ...
                'icon' => '✅',
                'tailwind_classes' => 'bg-green-50 text-green-800 border border-green-100 dark:bg-green-900 dark:text-green-200 dark:border-green-800',
                'meta' => null,
                'position' => 5,
                'status' => 1,
                'created_at' => $now,
