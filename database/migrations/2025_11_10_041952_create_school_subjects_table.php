...
return new class extends Migration
{
  ...
  <defs>
    <linearGradient id="mathGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#1E88E5"/> <!-- Material Blue 600 -->
      <stop offset="100%" stop-color="#90CAF9"/> <!-- Material Blue 200 -->
    </linearGradient>
  </defs>
  ...
  <defs>
    <linearGradient id="phyScienceGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#8E24AA"/> <!-- Material Purple 600 -->
      <stop offset="100%" stop-color="#CE93D8"/> <!-- Material Purple 200 -->
    </linearGradient>
  </defs>
...
';
  ...
  <defs>
    <linearGradient id="lifeScienceGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#2E7D32"/> <!-- Material Green 700 -->
      <stop offset="100%" stop-color="#A5D6A7"/> <!-- Material Green 200 -->
    </linearGradient>
  </defs>
  <text x="50%" y="60%" dominant-baseline="middle" text-anchor="middle"
        font-family="Inter, Roboto, Helvetica Neue, Arial, sans-serif"
...
';
    ...
    private function getPhysicsSvg() { return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 40" role="img" aria-label="Physics">
  <defs>
    <linearGradient id="physicsGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#1565C0"/> <!-- Material Blue 800 -->
      <stop offset="100%" stop-color="#64B5F6"/> <!-- Material Blue 300 -->
    </linearGradient>
  </defs>
  <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle"
        font-family="Inter, Roboto, Helvetica Neue, Arial, sans-serif"
...
'; }
    private function getChemistrySvg() { return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 40" role="img" aria-label="Chemistry">
  <defs>
    <linearGradient id="chemistryGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#00897B"/> <!-- Material Teal 600 -->
      <stop offset="100%" stop-color="#80CBC4"/> <!-- Material Teal 200 -->
    </linearGradient>
  </defs>
  <text x="50%" y="55%" dominant-baseline="middle" text-anchor="middle"
    ...
    private function getBiologySvg() { return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 40" role="img" aria-label="Biology">
  <defs>
...
'; }
    private function getHistorySvg() { return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 125 35" role="img" aria-label="History">
  <defs>
...
'; }
    private function getGeographySvg() { return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 190 40" role="img" aria-label="Geography">
  <defs>
...
'; }
    private function getEnglishSvg() { return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 125 35" role="img" aria-label="English">
  <defs>
...
'; }
    private function getBengaliSvg() { return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 35" role="img" aria-label="Bengali">
  <defs>
