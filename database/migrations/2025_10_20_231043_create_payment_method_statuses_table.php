...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $data = [
            ...
            ['type'=>'cod','slug'=>'payment_settled_return_closed_cod','title'=>'Payment Settled — Return Window Closed','description'=>'Payment fully settled and return window has expired.','class'=>'bg-emerald-100 text-emerald-700','position' => 6],
            ...
            ['type'=>'prepaid','slug'=>'payment_process_discontinued','title'=>'Payment Process Discontinued','description'=>'Payment Process Discontinued by customer.','class'=>'bg-yellow-100 text-yellow-700','position' => 4],
            ...
            ['type'=>'prepaid','slug'=>'payment_settled_return_closed_prepaid','title'=>'Payment Settled — Return Window Closed','description'=>'Payment fully settled and return window has expired.','class'=>'bg-emerald-100 text-emerald-700','position' => 11],
        ];
