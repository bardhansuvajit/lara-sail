<footer class="w-full bg-white rounded-lg sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased mt-4">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; {{applicationSettings('company_establish_year')}}-{{date('Y')}} <a href="{{applicationSettings('domain_name')}}" class="hover:underline" target="_blank">{{applicationSettings('company_name')}}</a>. All rights reserved.
    </p>
