<div class="py-3 hidden md:block">
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
        <ul class="flex items-center gap-8">
            ...
            <li>
                <x-front.dropdown width="w-max" align="left">
                    <x-slot name="trigger">
                    ...
                    <x-slot name="content">
                        {{-- <div class="z-10 w-full p-4 bg-white shadow sm:py-8 dark:bg-gray-800"> --}}
                        <div class="p-4">
                            <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
                                <div
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2">
                                            ...
                                            <p
                                                class="{{FD['text']}} font-semibold leading-tight dark:text-white">
                                                Electronics
                                            </p>
                                        </div>
                                ...
                                <div class="mt-8 lg:mt-12">
                                    <a href="#" title=""
                                        class="inline-flex items-center justify-center w-full py-2.5 px-5 gap-2 {{FD['text']}} font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 border-opacity-100 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-100 ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700/100"
                                        role="button">
                                        See all categories
