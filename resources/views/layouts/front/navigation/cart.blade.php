        ...
        <div class="z-50 mx-auto divide-y-2 overflow-hidden {{FD['rounded']}} bg-white antialiased dark:divide-gray-600 dark:bg-gray-700">
            ...
            {{-- <div class="grid grid-cols-2 items-center p-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <a href="#" class="text-clip {{FD['text']}} font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple iPad PRO</a>
                        <p class="mt-0.5 truncate {{FD['text']}} font-normal text-gray-500 dark:text-gray-400"><span class="currency-icon">$</span>1,899</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p
                            ...
                            <span class="currency-icon">$</span>899</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 items-center p-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p
                            class="mt-0.5 truncate {{FD['text']}} font-normal text-gray-500 dark:text-gray-400">
                            <span class="currency-icon">$</span>999</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 items-center p-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p
                            class="mt-0.5 truncate {{FD['text']}} font-normal text-gray-500 dark:text-gray-400">
                            <span class="currency-icon">$</span>1,099</p>
                    </div>
                </div>
            ...
            <div class="space-y-4 px-3 py-2 dark:border-gray-600">
                <dl class="flex items-center justify-between">
                    {{-- <dt class="font-semibold leading-tight dark:text-white">Total</dt> --}}
                ...
                <div class="flex space-x-2">
                    <a href="#" title="" class="inline-flex w-full items-center justify-center {{FD['rounded']}} bg-primary-600 px-5 py-2.5 {{FD['text']}} font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"> See your cart </a>
