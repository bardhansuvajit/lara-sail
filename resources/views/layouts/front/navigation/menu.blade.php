<div class="py-4 border-b border-gray-200 border-opacity-100 dark:border-gray-700">
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
        <div class="flex flex-wrap items-center justify-between gap-x-4 sm:gap-x-16 gap-y-4 md:gap-x-8 lg:flex-nowrap">
            ...
            <div class="relative md:hidden">
                <button type="button" class="inline-flex items-center justify-center p-2 text-sm rounded-lg font-medium leading-tight dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700/100">
                    {{-- <span class="custom-1">Menu</span> --}}
