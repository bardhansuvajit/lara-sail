<div class="fixed bottom-0 block sm:hidden w-full bg-gray-100 dark:bg-gray-800 shadow-lg">
    <div class="">
        <ul class="grid grid-cols-4 gap-2">
            ...
            <li>
                <a href="{{route('front.category.index')}}" class="group flex flex-col items-center justify-center {{FD['rounded']}} p-2.5 {{ Route::is('front.category.index') ? 'text-green-600 dark:text-green-600 font-bold' : 'text-gray-700 dark:text-primary-300 font-light' }} ">
                    <span class="mb-1 flex h-5 w-5 items-center justify-center {{FD['rounded']}}">
                        <div class="h-4 w-4">
            ...
            <li>
                <a href="{{route('front.cart.index')}}" class="group flex flex-col items-center justify-center {{FD['rounded']}} p-2.5 {{ Route::is('front.cart.index') ? 'text-green-600 dark:text-green-600 font-bold' : 'text-gray-700 dark:text-primary-300 font-light' }} ">
                    <span class="mb-1 flex h-5 w-5 items-center justify-center {{FD['rounded']}}">
            ...
            <li>
                <a href="{{route('front.login.index')}}" class="group flex flex-col items-center justify-center {{FD['rounded']}} p-2.5 {{ Route::is('front.login.index') ? 'text-green-600 dark:text-green-600 font-bold' : 'text-gray-700 dark:text-primary-300 font-light' }} ">
                    <span class="mb-1 flex h-5 w-5 items-center justify-center {{FD['rounded']}}">
                        <div class="h-4 w-4">
