    ...
    <div class="p-6">
        ...
        <div class="flex flex-col items-center justify-center space-y-6 min-h-[100px]">
            <div class="flex space-x-2">
                <div class="w-4 h-4 rounded-full bg-primary-500 animate-bounce [animation-delay:-0.3s]"></div>
                <div class="w-4 h-4 rounded-full bg-primary-500 animate-bounce [animation-delay:-0.15s]"></div>
                <div class="w-4 h-4 rounded-full bg-primary-500 animate-bounce"></div>
            </div>
