                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex gap-4 justify-start">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        @else
                                            <p class="{{FD['text-1']}} text-red-500 dark:text-red-600 mt-1">{{$item['availability_message']}}</p>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center gap-4 pt-1">
                                        <button 
                                            ...
                                            x-on:click="
                                                ...
                                                $dispatch('data-image-path', @js($item['image_s'] ? $item['image_s'] : ''));
                                            "
                                        >
                                            <div class="{{FD['iconClass']}}">
                        ...
                        @foreach ($savedItems as $saved_item)
                            <div class="{{ FD['rounded'] }} border border-gray-200 bg-white p-2 shadow-sm dark:border-gray-700 dark:bg-gray-800 relative overflow-hidden">
                                ...
                                <div class="flex justify-between gap-2 mt-3">
                                    ...
                                    @else
                                        <p class="{{FD['text-0']}} text-red-500 dark:text-red-600 mt-1">{{$saved_item->availability_message}}</p>
                                    @endif
