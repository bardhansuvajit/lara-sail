<div>
    <div class="grid grid-cols-2 md:grid-cols-6 gap-2 mt-4">
        @forelse ($features as $singleFeature)
            <div class="rounded border border-gray-200 bg-white p-2 shadow-sm dark:border-gray-700 dark:bg-gray-800 relative overflow-hidden">
                <a href="#">
        ...
        @empty
            <p class="italic">No Products found</p>
        @endforelse
