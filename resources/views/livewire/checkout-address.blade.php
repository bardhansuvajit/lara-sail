        ...
        @else
            ...
            {{-- <div class="mt-4"> --}}
                ...
                <div id="address-add-btns" class="mt-4">
                    <div class="flex justify-between">
                        <button type="button" class="inline-block {{ FD['text'] }} text-primary-500 dark:text-primary-300" @click.prevent="open('shipping'); $wire.openAddressForm('shipping')">
                            Change Delivery address
                        </button>

                        @if ( $billingAddressesCount == 0 )
                            <button type="button" class="inline-block {{ FD['text'] }} text-primary-500 dark:text-primary-300" @click.prevent="open('billing'); $wire.openAddressForm('billing')">
                                Add Billing address
                            </button>
                        @endif
                    </div>
