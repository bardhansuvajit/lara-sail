...
<div class="flex flex-col gap-4 py-4">
    ...
    <div class="grid grid-cols-3 gap-4 items-center justify-between">
        ...
        <div class="col-span-1 col-start-3 justify-self-end">
    ...
    {{-- Top banner ad --}}
    <div class="">
        <a href="{{ $ads[0]['url'] }}" class="block {{ FD['rounded'] }} overflow-hidden shadow">
        ...
        <main class="lg:col-span-3 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 p-4 {{ FD['rounded'] }} shadow">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-xs text-gray-500">Showing {{ count($categories) .' '. ( (count($categories) == 1) ? 'category' : 'categories' ) }}</div>
                </div>
                    ...
                    @foreach($categories as $cat)
                        <a href="{{ route('front.category.detail', $cat['slug']) }}">
                            <div class="bg-white dark:bg-gray-800 {{ FD['rounded'] }} p-1 sm:p-3 group transition h-full flex flex-col shadow-sm hover:shadow-lg border dark:border-gray-700 overflow-hidden">
                                ...
                                @else
                                    <div class="flex-1 flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-500 text-white">
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-white dark:from-primary-900 p-4 {{ FD['rounded'] }} shadow">
                    ...
                    @foreach($categories as $c)
                        <a href="">
                            <div class="bg-white dark:bg-gray-800 p-3 {{ FD['rounded'] }} flex items-center gap-3">
                                <img src="{{ Storage::url($c['image_s']) }}" alt="{{ $c['slug'] }}" class="w-auto h-14 object-cover {{ FD['rounded'] }}">
                                <div>
            ...
            <!-- Deals & limited time -->
            <div class="bg-red-50 dark:bg-red-900/30 p-4 {{ FD['rounded'] }} shadow">
                <div class="flex items-center justify-between mb-3">
                    <div>
