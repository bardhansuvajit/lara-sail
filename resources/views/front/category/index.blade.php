...
<section class="bg-gray-50 dark:bg-gray-900 py-6">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Explore categories</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Browse by category — discover curated picks, deals and top brands.</p>
            </div>

            <div class="hidden sm:flex items-center gap-3">
                <input type="text" placeholder="Search categories, products..." class="px-3 py-2 rounded border text-sm w-64" />
                <button class="px-4 py-2 bg-indigo-600 text-white rounded text-sm">Search</button>
            </div>
        </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-4 rounded shadow">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        @foreach($categories as $cat)
                            <a href="/category/{{ $cat['slug'] }}" class="group block bg-white dark:bg-gray-900 border dark:border-gray-700 hover:shadow-lg transition rounded overflow-hidden">
