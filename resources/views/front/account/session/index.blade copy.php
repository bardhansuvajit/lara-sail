...
<div class="space-y-2 md:space-y-4">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="{{ FD['text-2'] }} font-bold text-gray-900 dark:text-white">Manage Sessions</h1>
                <p class="{{ FD['text'] }} text-gray-600 dark:text-gray-400 mt-1">View and manage your active login sessions across different devices.</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full {{ FD['text'] }} text-left text-gray-500 dark:text-gray-400">
                            <thead class="{{ FD['text'] }} text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th class="px-4 py-3">Device & Location</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        @else
                                        <span class="px-2 py-1 bg-gray-100 text-gray-800 {{ FD['text'] }} font-medium rounded-full dark:bg-gray-700 dark:text-gray-300">
                                            Logged out
                                        </span>
                                        @endif
                                    </td>
