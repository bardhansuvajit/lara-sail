{{-- <div class="flex w-full items-center gap-3 sm:gap-4 bg-orange-500 dark:bg-orange-600 text-gray-900 dark:text-gray-100 px-2 sm:px-4 py-1 mt-2 sm:mt-4 font-light">
