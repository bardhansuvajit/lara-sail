<x-guest-layout
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 px-2 md:px-6 py-4 md:py-12">
        <div class="max-w-7xl mx-auto">
            ...
            {{-- Mission Section --}}
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-8 md:mb-16">
                <div>
                ...
                <div>
                    <h2 class="{{ FD['text-1'] }} font-semibold text-gray-800 dark:text-gray-200 mb-2 text-center md:text-left">
                        Our Mission
                    </h2>
                    <p class="{{ FD['text'] }} text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-1 mt-4">
                        ...
                        <div class="p-1">
                            <div class="flex items-center">
                                ...
                                <span class="{{ FD['text'] }}">Quality Products</span>
                            </div>
                        </div>
                        ...
                        <div class="p-1">
                            <div class="flex items-center">
                                ...
                                <span class="{{ FD['text'] }}">Fast Delivery</span>
                            </div>
                        </div>
                        ...
                        <div class="p-1">
                            <div class="flex items-center">
                                ...
                                <span class="{{ FD['text'] }}">Wide Product Range</span>
                            </div>
                        </div>
                        ...
                        <div class="p-1">
                            <div class="flex items-center">
                                ...
                                <span class="{{ FD['text'] }}">Secure Payments</span>
                            </div>
                        </div>
                        ...
                        <div class="p-1">
                            <div class="flex items-center">
                                ...
                                <span class="{{ FD['text'] }}">Easy Returns</span>
                            </div>
                        </div>
                        ...
                        <div class="p-1">
                            <div class="flex items-center">
                                ...
                                <span class="{{ FD['text'] }}">24/7 Customer Support</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-8 md:mb-16">
                <div class="order-2 md:order-1">
                    ...
                    <p class="{{ FD['text'] }} text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span class="ml-3 {{ FD['text'] }} text-gray-700 dark:text-gray-300">Quality & Authenticity</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-primary-600 dark:text-primary-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="ml-3 {{ FD['text'] }} text-gray-700 dark:text-gray-300">Customer-Centric Approach</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-primary-600 dark:text-primary-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="ml-3 {{ FD['text'] }} text-gray-700 dark:text-gray-300">Eco-Friendly Practices</span>
                        </li>
                    </ul>
                </div>
            ...
            {{-- <div class="mb-8 md:mb-16">
                <h2 class="{{ FD['text-1'] }} font-semibold text-gray-800 dark:text-gray-200 text-center mb-6">
                    Meet Our Team
                </h2>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-shadow text-center p-6">
                        ...
                        <h3 class="{{ FD['text-1'] }} font-medium text-gray-800 dark:text-gray-200">{{ $member['name'] }}</h3>
                        <p class="{{ FD['text'] }} text-gray-600 dark:text-gray-400">{{ $member['role'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div> --}}
            ...
            <div class="text-center">
                <h2 class="{{ FD['text-1'] }} font-semibold text-gray-800 dark:text-gray-200 mb-2">
                    Join Our Journey
                </h2>
                <p class="{{ FD['text'] }} text-gray-600 dark:text-gray-400 max-w-lg mx-auto mb-6">
