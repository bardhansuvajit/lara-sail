<x-app-layout
    ...
    <section class="bg-white dark:bg-gray-900 antialiased mt-36 sm:mt-44">
        <div class="sm:pt-6">
            ...
            <div class="mt-6 sm:mt-6 md:gap-6 lg:flex lg:items-start xl:gap-8">
                            ...
                            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                ...
                                <div class="flex items-center justify-between md:order-3 md:justify-end">
                                    ...
                                    <div class="text-end md:order-4 md:w-32">
                                        <p class="text-base font-bold text-gray-900 dark:text-white"><span class="currency-icon">$</span>1,09,699</p>
                                    </div>
                                </div>

                                <div class="w-full min-w-0 flex-1 md:order-2 md:max-w-md">
                                    <a href="#" class="block {{FD['text']}} leading-tight font-medium text-gray-900 hover:underline dark:text-white sm:mb-2">
                                        PC system All in One APPLE iMac (2023) mqrq3ro/a, Apple M3, 24" Retina 4.5K, 8GB, SSD 256GB, 10-core GPU, Keyboard layout INT
                                    </a>

                                    <p class="{{FD['text']}} dark:text-gray-400">here lies the product description. Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro laudantium aut officia ipsa reiciendis provident quibusdam soluta possimus. Quos, numquam excepturi nulla alias ab officiis! Illo, pariatur unde. Consequuntur, obcaecati?</p>

                                    <div class="flex items-center gap-4 mt-4">

                                        <button type="button" class="inline-flex gap-2 items-center text-sm font-medium text-gray-500 hover:text-gray-900 hover:underline dark:text-gray-400 dark:hover:text-white">
                                        ...
                                        <button type="button" class="inline-flex gap-2 items-center text-sm font-medium text-red-500 hover:text-red-800 hover:underline dark:text-red-600 dark:hover:text-red-700">
                                            <div class="{{FD['iconClass']}}">
                ...
                <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                    <div
                        class="space-y-4 {{FD['rounded']}} border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                        <p class="{{FD['text-1']}} font-semibold text-gray-900 dark:text-white">Order summary</p>
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="{{FD['text']}} font-normal text-gray-500 dark:text-gray-400">Store Pickup</dt>
                                    <dd class="{{FD['text']}} font-medium text-gray-900 dark:text-white">$99</dd>
                                </dl>
