...
>
    ...
    <div class="w-full mt-2">
        <form action="{{ route('admin.school.listing.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid gap-4 mb-6 sm:grid-cols-3">
                <div>
                    ...
                    @if($data->logo_path)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $data->logo_path) }}" alt="{{ $data->name }}" class="w-20 h-20 object-cover rounded">
                        </div>
                    @endif
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-1">
                    <div>
                        ...
                        <x-admin.text-input id="name" class="block w-full" type="text" name="name" :value="old('name', $data->name)" placeholder="Enter school name" autofocus required />
                ...
                <div class="grid gap-4 mt-4 sm:grid-cols-3">
                    <div>
                        ...
                        <x-admin.text-input id="code" class="block w-full" type="text" name="code" :value="old('code', $data->code)" placeholder="Enter school code" />
            ...
            <div class="mb-6">
                <div>
                    ...
                    <x-admin.textarea id="description" class="block w-full" name="description" placeholder="Enter school description" maxlength="1000" :value="old('description', $data->description)"></x-admin.textarea>
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-3 mb-3">
                            ...
                            @slot('options')
                                @foreach ($activeCountries as $country)
                                    <x-admin.input-select-option
                                        value="{{$country->code}}" 
                                        :selected="old('country_code', $data->country_code ?? 'IN') == $country->code"
                                        >
                                        {{$country->name}}
                                    </x-admin.input-select-option>
                                @endforeach
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="state" class="block w-full" type="text" name="state" :value="old('state', $data->state)" placeholder="Enter state" required />
                        <x-admin.input-error :messages="$errors->get('state')" class="mt-2" />
                    </div>

                    <div>
                        <x-admin.input-label for="district" :value="__('District *')" />
                        <x-admin.text-input id="district" class="block w-full" type="text" name="district" :value="old('district', $data->district)" placeholder="Enter district" />
                        <x-admin.input-error :messages="$errors->get('district')" class="mt-2" />
                    </div>

                    <div>
                        <x-admin.input-label for="city" :value="__('City *')" />
                        <x-admin.text-input id="city" class="block w-full" type="text" name="city" :value="old('city', $data->city)" placeholder="Enter city" />
                        <x-admin.input-error :messages="$errors->get('city')" class="mt-2" />
                    </div>

                    <div>
                        <x-admin.input-label for="pincode" :value="__('Pincode')" />
                        <x-admin.text-input id="pincode" class="block w-full" type="text" name="pincode" :value="old('pincode', $data->pincode)" placeholder="Enter pincode" />
                ...
                <div class="grid gap-4 sm:grid-cols-1">
                    <div>
                        ...
                        <x-admin.textarea id="address" class="block w-full" name="address" placeholder="Enter Street Address" maxlength="1000" :value="old('address', $data->address)"></x-admin.textarea>
                        ...
                        <x-admin.input-select id="type" name="type" title="Select type" class="w-full">
                            @slot('options')
                                @foreach ($schoolType as $key => $val)
                                    <x-admin.input-select-option value="{{ $key }}" :selected="old('type', $data->type) == $key">{{ $val }}</x-admin.input-select-option>
                                @endforeach
                            @endslot
                        </x-admin.input-select>
                        ...
                        <x-admin.input-select id="level" name="level" title="Select Education Level" class="w-full">
                            @slot('options')
                                @foreach ($educationLevel as $key => $val)
                                    <x-admin.input-select-option value="{{ $key }}" :selected="old('level', $data->level) == $key">{{ $val }}</x-admin.input-select-option>
                                @endforeach
                            @endslot
                        </x-admin.input-select>
                        ...
                        <x-admin.input-select id="board_affiliation" name="board_affiliation" title="Select Education board_affiliation" class="w-full">
                            @slot('options')
                                @foreach ($activeBoards as $board)
                                    <x-admin.input-select-option value="{{ $board->slug }}" :selected="old('board_affiliation', $data->board_affiliation) == $board->slug">{{ $board->name }}</x-admin.input-select-option>
                                @endforeach
                            @endslot
                        </x-admin.input-select>
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <x-admin.text-input id="established_year" class="block w-full" type="number" name="established_year" :value="old('established_year', $data->established_year)" placeholder="e.g., 1950" min="1000" max="9999" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="principal_name" class="block w-full" type="text" name="principal_name" :value="old('principal_name', $data->principal_name)" placeholder="Enter principal name" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="student_count" class="block w-full" type="number" name="student_count" :value="old('student_count', $data->student_count)" placeholder="Total students" min="0" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="teacher_count" class="block w-full" type="number" name="teacher_count" :value="old('teacher_count', $data->teacher_count)" placeholder="Total teachers" min="0" />
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <x-admin.text-input id="official_email" class="block w-full" type="email" name="official_email" :value="old('official_email', $data->official_email)" placeholder="school@email.com" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="phone_number" class="block w-full" type="text" name="phone_number" :value="old('phone_number', $data->phone_number)" placeholder="+91-XXX-XXXXXXX" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="alternate_phone" class="block w-full" type="text" name="alternate_phone" :value="old('alternate_phone', $data->alternate_phone)" placeholder="Alternate contact number" />
                        <x-admin.input-error :messages="$errors->get('alternate_phone')" class="mt-2" />
                    </div>

                    <div>
                        <x-admin.input-label for="fax" :value="__('Fax')" />
                        <x-admin.text-input id="fax" class="block w-full" type="text" name="fax" :value="old('fax', $data->fax)" placeholder="Fax number" />
                        <x-admin.input-error :messages="$errors->get('fax')" class="mt-2" />
                    </div>

                    <div class="sm:col-span-2">
                        <x-admin.input-label for="website" :value="__('Website')" />
                        <x-admin.text-input id="website" class="block w-full" type="url" name="website" :value="old('website', $data->website)" placeholder="https://school-website.com" />
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <x-admin.text-input id="contact_person_name" class="block w-full" type="text" name="contact_person_name" :value="old('contact_person_name', $data->contact_person_name)" placeholder="Contact person name" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="contact_person_designation" class="block w-full" type="text" name="contact_person_designation" :value="old('contact_person_designation', $data->contact_person_designation)" placeholder="e.g., Principal, Admin" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="contact_person_mobile" class="block w-full" type="text" name="contact_person_mobile" :value="old('contact_person_mobile', $data->contact_person_mobile)" placeholder="Contact person mobile" />
                    ...
                    <div>
                        ...
                        <x-admin.text-input id="contact_person_email" class="block w-full" type="email" name="contact_person_email" :value="old('contact_person_email', $data->contact_person_email)" placeholder="contact@email.com" />
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-1">
                    <div>
                        ...
                        <x-admin.text-input id="meta_title" class="block w-full" type="text" name="meta_title" :value="old('meta_title', $data->meta_title)" placeholder="Enter meta title for SEO" maxlength="60" />
                    ...
                    <div>
                        ...
                        <x-admin.textarea id="meta_description" class="block w-full" name="meta_description" placeholder="Enter meta description for SEO" maxlength="160" :value="old('meta_description', $data->meta_description)"></x-admin.textarea>
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <x-admin.text-input id="tags" class="block w-full" type="text" name="tags" :value="old('tags', $data->tags ? implode(', ', json_decode($data->tags, true)) : '')" placeholder="Enter tags as comma separated values" />
