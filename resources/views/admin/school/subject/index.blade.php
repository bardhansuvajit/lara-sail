...
>
                                ...
                                <div class="flex space-x-2 items-center justify-end">
                                    ...
                                    <x-admin.button-icon
                                        ...
                                        x-on:click.prevent="
                                            ...
                                            $dispatch('data-category', `{{ $item->category }}`);
                                            $dispatch('data-description', `{{ htmlspecialchars($item->description, ENT_QUOTES) }}`);
                                            $dispatch('data-metat', `{{ htmlspecialchars($item->meta_title, ENT_QUOTES) }}`);
                                            $dispatch('data-metad', `{{ htmlspecialchars($item->meta_description, ENT_QUOTES) }}`);
    ...
    <x-admin.sidebar name="quick-data-view" maxWidth="sm" direction="right" header="Quick View" focusable>
        <div 
            ...
            x-on:data-category.window="category = $event.detail"
        ...
        >
            ...
            <div class="space-y-3">
                ...
                <div class="text-gray-400 dark:text-gray-400 font-thin">
                    <h5 class="text-xs font-bold mb-1">Code</h5>
                    <p class="text-sm text-gray-700 dark:text-gray-300 font-medium" x-text="code"></p>
                </div>

                <div class="text-gray-400 dark:text-gray-400 font-thin">
                    <h5 class="text-xs font-bold mb-1">Category</h5>
                    <p class="text-sm text-gray-700 dark:text-gray-300 font-medium" x-text="category"></p>
                </div>
