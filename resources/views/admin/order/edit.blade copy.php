    ...
    <div class="w-full mt-4 space-y-4">
                        ...
                        @foreach ($order->items as $item)
                            <div class="flex flex-col space-y-2 items-center">
                                ...
                                <div class="flex-1 min-w-0">
                                    <a href="{{ route('admin.product.listing.edit', $item->id) }}" target="_blank" class="{{FD['text']}} font-medium text-gray-900 dark:text-white truncate underline hover:no-underline">
                                        {{ $item->product_title }}
                                    </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div class="flex flex-col">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-2 md:p-4 h-full flex flex-row justify-between {{ FD['rounded'] }}">
                    <div>
                        <p class="{{FD['text']}} text-gray-900 dark:text-white font-medium inline-block underline hover:no-underline">
