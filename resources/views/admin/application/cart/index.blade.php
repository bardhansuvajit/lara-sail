                ...
                @foreach ($data as $item)
                    ...
                    <div class="grid grid-cols-4">
                        <div class="col-span-1">
                            ...
                            <p class="text-xs font-semibold text-gray-900 dark:text-white">{{ $currencySymbol }}{{ $item->min_order_value }}</p>
                        </div>

                        <div class="col-span-1">
                            <p class="text-xs  text-gray-500 dark:text-gray-400">Shipping Charge</p>
                            <p class="text-xs font-semibold text-gray-900 dark:text-white">{{ $currencySymbol }}{{ $item->shipping_charge }}</p>
                        </div>

                        <div class="col-span-1">
                            <p class="text-xs  text-gray-500 dark:text-gray-400">Free Shipping Threshold</p>
                            <p class="text-xs font-semibold text-gray-900 dark:text-white">{{ $currencySymbol }}{{ $item->free_shipping_threshold }}</p>
                        </div>
                    </div>
