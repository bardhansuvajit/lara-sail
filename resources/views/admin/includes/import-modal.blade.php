...
>
    <div
        ...
        x-on:set-model.window="model = $event.detail" 
    >
        <form 
        method="post" 
        :action="route" 
        ...
        @csrf
            ...
            <div class="mt-4">
                <a :href="'{{ route('admin.csv-template.download', '') }}' + '/' + model" class="font-extralight text-primary-700 hover:text-primary-900 dark:text-primary-100 dark:hover:text-primary-200 text-xs inline-flex" target="_blank">
