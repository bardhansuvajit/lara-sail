...
>
    ...
    >
        <div class="p-4">
            ...
            <div class="mt-3 flex items-center text-red-600 dark:text-orange-600">
                ...
                <p class="text-base font-medium text-red-600 dark:text-orange-600">{!! __('Exports only whats rendered on view') !!}</p>
            </div>
            ...
            <div class="mt-4 flex space-x-2">
                <x-admin.button 
                    element="a" 
                    tag="primary" 
                    x-bind:href="route.split('/').slice(0, -1).join('/') + '/' + 'excel' + '?' + '{{ http_build_query(request()->query()) }}'" 
                    title="Cancel" 
                    class="border" 
                ...
                <x-admin.button 
                    element="a" 
                    tag="primary" 
                    x-bind:href="route.split('/').slice(0, -1).join('/') + '/' + 'csv' + '?' + '{{ http_build_query(request()->query()) }}'" 
                    title="Cancel" 
                    class="border" 
                    x-on:click="$dispatch('close')" 
                >
                ...
                <x-admin.button 
                    element="a" 
                    tag="primary" 
                    x-bind:href="route.split('/').slice(0, -1).join('/') + '/' + 'html' + '?' + '{{ http_build_query(request()->query()) }}'" 
                    title="Cancel" 
                    class="border" 
                    x-on:click="$dispatch('close')" 
                >
                ...
                <x-admin.button 
                    element="a" 
                    tag="primary" 
                    x-bind:href="route.split('/').slice(0, -1).join('/') + '/' + 'pdf' + '?' + '{{ http_build_query(request()->query()) }}'" 
                    title="Cancel" 
                    class="border" 
                    x-on:click="$dispatch('close')" 
                >
