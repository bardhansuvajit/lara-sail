...
>
    ...
    <div class="w-full mt-2">
        <form action="{{ route('admin.website.social.media.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                <div>
                    <x-admin.input-label for="name" :value="__('Name *')" />
                    <x-admin.text-input id="name" class="block w-full" type="text" name="name" :value="old('name')" placeholder="Enter Name" autofocus required />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-1">
                <div>
                    ...
                    <x-admin.textarea id="icon_colored" class="block" type="text" name="icon_colored" :value="old('icon_colored')" placeholder="e.g. <svg..." />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-1">
                <div>
                    ...
                    <x-admin.textarea id="icon_base" class="block" type="text" name="icon_base" :value="old('icon_base')" placeholder="e.g. <svg..." />
            ...
            <div>
                ...
                <x-admin.textarea id="url" class="block" type="text" name="url" :value="old('url')" placeholder="Enter Redirect URL" maxlength="1000" />
