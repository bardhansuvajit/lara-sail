<x-admin-app-layout
    ...
    title="{{ __('Create Product Review') }}"
    :breadcrumb="[
        ...
        <form action="{{ route('admin.product.review.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        @for ($i = 1; $i < 6; $i++)
                            <li>
                                <x-admin.radio-input-button 
                                    ...
                                    class="w-auto px-2" 
                                    required 
                                    :checked="old('rating') ? old('rating') == $i : $i == 1" />
                            </li>
                        @endfor
                    </ul>
            ...
            <div class="grid gap-4 mb-3 grid-cols-1 items-center">
                <div>
                    ...
                    <x-admin.text-input id="title" class="block" type="text" name="title" :value="old('title')" placeholder="Enter Title" />
            ...
            <div class="grid gap-4 mb-3 grid-cols-1 items-center">
                <div>
                    ...
                    <x-admin.textarea id="review" class="block" type="text" name="review" :value="old('review')" placeholder="Enter Review" />
