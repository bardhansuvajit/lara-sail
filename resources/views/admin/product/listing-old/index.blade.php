...
>
    ...
    <section class="sm:rounded-lg overflow-hidden px-1 py-2">
        ...
        <div class="flex space-x-2 justify-end">
            <x-admin.button
                element="a"
                :href="route('admin.product.listing.create')">
                @slot('icon')
            ...
            <div class="grid grid-cols-10 gap-4 py-4">
                ...
                <div class="col-span-8 flex flex-row space-x-1 justify-end items-end">
                    ...
                    <div class="basis-1/5">
                        ...
                        <x-admin.text-input id="keyword" class="h-[2.3rem]" type="text" name="keyword" :value="request()->input('keyword')" placeholder="Keywords..." />
                    </div>
