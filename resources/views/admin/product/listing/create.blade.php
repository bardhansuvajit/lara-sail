...
>
    ...
    <section class="grid grid-cols-6 md:grid-cols-10 gap-4">
        <div class="col-span-2">
            ...
            <aside id="default-sidebar" class="fixed w-64 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        ...
        <div class="col-span-6">
            <div class="w-full mt-2">
                <form action="{{ route('admin.product.listing.store') }}" method="post" enctype="multipart/form-data" onsubmit="syncEditorContent()">
                    ...
                    <h5 class="text-xs mt-2 mb-4 font-bold dark:text-white">Basics</h5>
        ...
        <div class="col-span-2">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cumque nihil quo reiciendis vitae expedita ratione aliquid qui nam laudantium mollitia architecto eum consequatur impedit, possimus veniam molestias natus culpa ducimus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium rerum, nihil facilis non id expedita reprehenderit a tempora, dicta deleniti, sunt veritatis repellat! Quam quod sapiente et repudiandae ut perspiciatis.
        </div>
    </section>
</x-admin-app-layout>
