            ...
            <div class="grid gap-4 mb-4 grid-cols-1">
                <div>
                    ...
                    <div class="w-full border border-gray-200 rounded bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        <div class="">
                            <div class="bg-gray-50 dark:bg-gray-700 p-2 flex items-center space-x-1 rtl:space-x-reverse flex-wrap h-[52px]" id="toolbar"></div>

                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-900">
                                <div id="editor" contenteditable="true" onkeyup="updateToolbar()" onmouseup="updateToolbar()" class="min-h-20 block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-900 focus:ring-0 dark:text-white dark:placeholder-gray-400 focus:outline-0"><p></p></div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function updateToolbar() {
        document.querySelectorAll('#toolbar button').forEach(button => button.classList.remove('bg-gray-800', 'text-white'));
        ...
        if (selection) {
            ...
            while (element && element !== document.getElementById('editor')) {
                ...
                if (tag === 'P') document.getElementById('pBtn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'H1') document.getElementById('h1Btn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'H2') document.getElementById('h2Btn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'H3') document.getElementById('h3Btn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'H4') document.getElementById('h4Btn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'H5') document.getElementById('h5Btn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'H6') document.getElementById('h6Btn')?.classList.add('bg-gray-800', 'text-white');

                // Text Formatting Button States
                else if (tag === 'B' || tag === 'STRONG') document.getElementById('boldBtn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'I' || tag === 'EM') document.getElementById('italicBtn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'U') document.getElementById('underlineBtn')?.classList.add('bg-gray-800', 'text-white');
                else if (tag === 'STRIKE') document.getElementById('strikeBtn')?.classList.add('bg-gray-800', 'text-white');

                // Highlight Button State (checks for span with highlight class)
                else if (tag === 'SPAN' && element.classList.contains('bg-yellow-300')) {
                    document.getElementById('highlightBtn')?.classList.add('bg-gray-800', 'text-white');
                }
    ...
    function toggleSource() {
        ...
        if (!isSourceMode) {
            ...
            textarea.classList.add('w-full', 'h-64', 'p-2', 'border', 'border-gray-300', 'dark:border-gray-600', 'rounded', 'resize-none', 'focus:outline-none', 'dark:bg-gray-800', 'dark:text-gray-300');
