...
>
    ...
    <div class="w-full mt-2">
        <form action="{{ route('admin.product.listing.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid gap-4 mb-4 grid-cols-1">
                <div id="toolbar">
                    ...
                    <button type="button" onclick="document.getElementById('imageUpload').click()">Image</button>
                </div>
                <div id="editor" contenteditable="true"></div>

                {{-- <div>
                    <x-admin.input-label for="title" :value="__('Description *')" />
                    ...
                    <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                        <label for="wysiwyg-example" class="sr-only">Wysiwyg Container</label>

                        <div id="wysiwyg-container"class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 outline-0 h-[4rem]" contenteditable="true" data-text="Enter comment...."></div>
                    </div>
                </div> --}}
            </div>
