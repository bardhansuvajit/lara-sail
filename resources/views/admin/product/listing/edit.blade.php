                ...
                <form action="{{ route('admin.product.listing.store') }}" method="post" enctype="multipart/form-data" onsubmit="syncEditorContent()">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        <div>
                            ...
                            <div id="editor" name="description">{!! $data->long_description !!}</div>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        <div x-data="{ open: {{ (old('short_description') || !empty($data->short_description)) ? 'true' : 'false' }} }">
                            ...
                            <div x-show="open" class="mt-4">
                                ...
                                <x-admin.textarea id="short_description" class="block" type="text" name="short_description" :value="old('short_description') ? old('short_description') : $data->short_description" placeholder="Enter Short Description" />
