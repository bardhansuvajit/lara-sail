        ...
        <form action="{{ route('admin.product.variation.attribute.value.update') . (request()->getQueryString() ? '?'.request()->getQueryString() : '') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 mb-4 grid-cols-1">
                <div>
                    ...
                    <x-admin.textarea id="meta" class="block" type="text" name="meta" :value="old('meta') ? old('meta') : $data->meta" placeholder="Enter Meta" />
            ...
            <div class="grid gap-4 mb-4 grid-cols-1">
                <div>
                    ...
                    <x-admin.textarea id="long_description" class="block" type="text" name="long_description" :value="old('long_description') ? old('long_description') : $data->long_description" placeholder="Enter Long Description" />
            ...
            <div class="grid gap-4 mb-4 grid-cols-1">
                <div>
                    ...
                    <x-admin.textarea id="tags" class="block" type="text" name="tags" :value="old('tags') ? old('tags') : $data->tags" placeholder="Enter Tags" />
