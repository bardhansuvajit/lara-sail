        ...
        <form action="{{ route('admin.product.coupon.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                <div>
                    ...
                    <x-admin.text-input id="code" class="block w-full" type="text" name="code" :value="old('code')" placeholder="Enter code" autofocus required />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                <div>
                    ...
                    <x-admin.text-input id="name" class="block w-full" type="text" name="name" :value="old('name')" placeholder="Enter name" required />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <x-admin.text-input id="value" class="block w-full" type="text" name="value" :value="old('value')" placeholder="Enter value" required />
                ...
                <div>
                    ...
                    <x-admin.text-input id="max_discount_amount" class="block w-full" type="text" name="max_discount_amount" :value="old('max_discount_amount')" placeholder="Enter maximum discount amount" required />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                <div>
                    ...
                    <x-admin.text-input id="min_cart_value" class="block w-full" type="text" name="min_cart_value" :value="old('min_cart_value')" placeholder="Enter minimum cart value" required />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                <div>
                    ...
                    <x-admin.text-input id="usage_limit" class="block w-full" type="text" name="usage_limit" :value="old('usage_limit')" placeholder="Enter usage limit" required />
                ...
                <div>
                    ...
                    <x-admin.text-input id="usage_per_user" class="block w-full" type="text" name="usage_per_user" :value="old('usage_per_user', 1)" placeholder="Enter usage per user" required />
