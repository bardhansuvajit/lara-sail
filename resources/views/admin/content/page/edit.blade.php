...
>
    ...
    <div class="w-full mt-2">
        <form action="{{ route('admin.website.content.page.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid gap-4 mb-3 grid-cols-1 items-center">
                <div>
                    ...
                    <x-admin.text-input id="meta_title" class="block" type="text" name="meta_title" :value="old('meta_title', $data->meta_title)" placeholder="Enter Meta Title" />
            ...
            <div class="grid gap-4 mb-3 grid-cols-1 items-center">
                <div>
                    ...
                    <x-admin.textarea id="meta_description" class="block" type="text" name="meta_description" :value="old('meta_description', $data->meta_description)" placeholder="Enter Meta Description" />
