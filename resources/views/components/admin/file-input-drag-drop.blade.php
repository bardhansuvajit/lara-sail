    ...
    >
        <div class="w-full flex flex-row items-center justify-between px-4">
            ...
            <div class="">
                ...
                <p class="text-xs text-gray-400 dark:text-gray-400">Supports image files (Max size 1MB)</p>
            </div>
        </div>
        ...
        <input id="dropzone-file" type="file" class="hidden" {{ $disabled ? 'disabled' : '' }} {{ $multiple ? 'multiple' : '' }} />
    </label>
</div>
