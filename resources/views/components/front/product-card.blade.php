...
>
  ...
  <a href="{{ route('front.product.detail', $product->slug) }}"
	 class="block focus:outline-none focus:ring-4 focus:ring-indigo-500/30 relative z-0"
  >
	...
	@if (count($product->pricings) > 0)
	  ...
	  <div class="mt-3 flex items-center justify-between gap-2">
		...
		<div class="hidden sm:flex items-center text-xs text-gray-500 dark:text-gray-300">
		  <svg class="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M3 7h13l4 4v6H3zM16 3v4"/></svg>
		  <span>Fast</span>
		</div>
	  </div>
	@endif
