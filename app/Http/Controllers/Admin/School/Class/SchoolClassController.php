...
namespace App\Http\Controllers\Admin\School\Class;
...
class SchoolClassController
{
    ...
    public function index(Request $request): View
    {
        ...
        $resp = $this->schoolClassRepository->list($keyword, $filters, $perPage, $sortBy, $sortOrder);
    ...
    public function store(Request $request)
    {
        ...
        $resp = $this->schoolClassRepository->store($request->all());
        return redirect()->route('admin.school.class.index')->with($resp['status'], $resp['message']);
    }

    public function edit(int $id): View|RedirectResponse
    {
        $resp = $this->schoolClassRepository->getById($id);
        // dd($resp);
        if ($resp['code'] == 200) {
    ...
    public function update(Request $request)
    {
        ...
        $resp = $this->schoolClassRepository->update($request->all());
        // dd($resp);
        return redirect()->route('admin.school.class.index')->with($resp['status'], $resp['message']);
    }
    ...
    {
        $resp = $this->schoolClassRepository->delete($id);
        return redirect()->back()->with($resp['status'], $resp['message']);
    }
    ...
    public function bulk(Request $request)
    {
        ...
        $resp = $this->schoolClassRepository->bulkAction($request->except('_token'));
        return redirect()->back()->with($resp['status'], $resp['message']);
    }
    ...
    public function import(Request $request)
    {
        ...
        $resp = $this->schoolClassRepository->import($request->file('file'));
        return redirect()->back()->with($resp['status'], $resp['message']);
    }
    ...
    public function export(Request $request, String $type)
    {
        ...
        $resp = $this->schoolClassRepository->export($keyword, $filters, $perPage, $sortBy, $sortOrder, $type);
    ...
    {
        $resp = $this->schoolClassRepository->position($request->ids);
        return $resp;
        // return redirect()->back()->with($resp['status'], $resp['message']);
    }
}
