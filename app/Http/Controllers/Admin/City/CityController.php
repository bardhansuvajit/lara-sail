...
class CityController
{
    ...
    public function index(Request $request): View
    {
        ...
        $resp = $this->cityRepository->list($keyword, $filters, $perPage, $sortBy, $sortOrder);
    ...
    public function store(Request $request)
    {
        ...
        $resp = $this->cityRepository->store($request->all());
    ...
    public function update(Request $request)
    {
        ...
        $resp = $this->cityRepository->update($request->all());
        return redirect()->route('admin.city.index')->with($resp['status'], $resp['message']);
    }
    ...
    public function bulk(Request $request)
    {
        ...
        $resp = $this->cityRepository->bulkAction($request->except('_token'));
        return redirect()->back()->with($resp['status'], $resp['message']);
    }
    ...
    public function import(Request $request)
    {
        ...
        $resp = $this->cityRepository->import($request->file('file'));
        return redirect()->back()->with($resp['status'], $resp['message']);
    }
    ...
    public function export(Request $request, String $type)
    {
        ...
        $resp = $this->cityRepository->export($keyword, $filters, $perPage, $sortBy, $sortOrder, $type);
