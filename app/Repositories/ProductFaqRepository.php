...
class ProductFaqRepository implements ProductFaqInterface
{
    ...
    public function store(array $array)
    {
        ...
        try {
            ...
            $lastPosition = ProductFaq::where('product_id', $productId)
            ->max('position');
    ...
    protected function checkExistingVariation($productId, array $variations)
    {
        ...
        $variationIds = ProductFaq::where('product_id', $productId)
            ->pluck('id');
        ...
        return ProductFaq::with('combinations')
    ...
    public function import(UploadedFile $file)
    {
        try {
            ...
            // $processedCount = saveToDatabase($data, 'ProductFaq');
    ...
    public function position(array $ids)
    {
        try {
            ...
            foreach ($ids as $index => $id) {
                $resp = ProductFaq::where('id', $id)->update([
                    'position' => $index + 1
                ]);
            }
